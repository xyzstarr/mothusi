/**
 * @ngdoc controller
 * @name mothusiApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
	...
	/**
	 * @ngdoc function
	 * @name mothusiApp.admin.user.list.edit.provider:UserEditController
	 * @description
	 * Provider of the {@link mothusiApp.admin.user.list.edit.controller:UserEditController UserEditController}
