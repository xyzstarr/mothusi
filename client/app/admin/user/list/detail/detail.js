/**
 * @ngdoc overview
 * @name mothusiApp.admin.user.list.detail
 * @description
 * The `mothusiApp.admin.user.list.detail` module which provides:
 *
 * - {@link mothusiApp.admin.user.list.detail.controller:UserDetailController UserDetailController}
 *
 * @requires ui.router
 * @requires angularMoment
 * @requires mothusiApp.auth.user
 */
(function () {
	'use strict';
