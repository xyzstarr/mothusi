/**
 * @ngdoc overview
 * @name mothusiApp.admin.user.create
 * @description
 * The `mothusiApp.admin.user.create` module which provides
 *
 * - {@link mothusiApp.admin.user.create.controller:UserCreateController UserCreateController}
 *
 * @requires ui.router
 * @requires ngMaterial
 * @requires ngMessages
...
(function () {
	...
	angular
		.module('mothusiApp.admin.user.create', [
			...
			'mothusiApp.auth',
			'mothusiApp.toast',
			'mothusiApp.remoteUnique',
			'mothusiApp.mongooseError'
		])
