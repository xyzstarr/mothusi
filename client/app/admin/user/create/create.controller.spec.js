/**
 * @ngdoc controller
 * @name mothusiApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
	...
	angular
		.module('mothusiApp.admin.user.create')
		.controller('UserCreateController', UserCreateController);

	/**
	 * @ngdoc function
	 * @name mothusiApp.admin.user.create.provider:UserCreateController
	 * @description
	 * Provider of the {@link mothusiApp.admin.user.create.controller:UserCreateController UserCreateController}
	 *
	 ...
	 * @returns {Service} {@link mothusiApp.admin.user.create.controller:UserCreateController UserCreateController}
	 */
	...
	function UserCreateController($mdDialog, Auth, User, Toast) {
		 ...
		 * @ngdoc property
		 * @name userRoles
		 * @propertyOf mothusiApp.admin.user.create.controller:UserCreateController
		 * @description
		 ...
		 * @ngdoc function
		 * @name create
		 * @methodOf mothusiApp.admin.user.create.controller:UserCreateController
		 * @description
