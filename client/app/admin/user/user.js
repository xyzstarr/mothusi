(function () {
	...
	/**
	 * Introduce the mothusiApp.user module
	 * and configure it.
	 *
	 * @requires ngResource
	 * @requires ui.router
	 * @requires {mothusiApp.admin.user.list}
	 * @requires {mothusiApp.admin.user.create}
	 */
	angular
		.module('mothusiApp.admin.user', [
			'ngResource',
			'ui.router',
			'mothusiApp.admin.user.list',
			'mothusiApp.admin.user.create'
		])
